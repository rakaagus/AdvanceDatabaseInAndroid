...
import com.dicoding.mystudentdata.database.CourseStudentCrossOf
...
object InitialDataSource {
    ...
    fun getCourseStudentRelation(): List<CourseStudentCrossOf>{
        return listOf(
            CourseStudentCrossOf(1, 1),
            CourseStudentCrossOf(1, 2),
            CourseStudentCrossOf(2, 2),
            CourseStudentCrossOf(2, 5),
            CourseStudentCrossOf(3, 3),
            CourseStudentCrossOf(4, 3),
            CourseStudentCrossOf(4, 4),
            CourseStudentCrossOf(5, 4),
            CourseStudentCrossOf(6, 3),
            CourseStudentCrossOf(6, 4),
        )
    }
